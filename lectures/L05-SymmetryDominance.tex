...
\begin{frame}{Dominance Breaking}
  ...
  \begin{definition}[Dominance]
    Given a \emph{minimisation} problem with objective function $f$, a (partial) assignment $s_1$ \defined{dominates} a (partial) assignment $s_2$
    (written $s_1 \prec s_2$) if: whenever $s_2$ can be extended to a feasible solution of cost $c$,
    there exists a feasible extension of $s_1$ with cost at most $c$.
    In particular, discarding dominated assignments never loses an optimal solution.
  \end{definition}
\end{frame}
